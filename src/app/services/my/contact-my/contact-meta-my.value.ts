...
export const ContactMetaMY: ContactMeta = {
  salutation: [
    { value: 'Mr', label: 'Mr' },
    { value: 'Mrs', label: 'Mrs' },
    { value: 'Ms', label: 'Ms' },
    { value: "Dato'", label: "Dato'" },
    { value: "Dato' Seri", label: "Dato' Seri" },
    { value: 'Datuk', label: 'Datuk' },
    { value: 'Datuk Seri', label: 'Datuk Seri' },
    { value: "Datin'", label: "Datin'" },
    { value: "Datin' Seri", label: "Datin' Seri" },
    { value: 'Doctor', label: 'Doctor' },
    { value: 'Puan Sri', label: 'Puan Sri' },
    { value: 'Tan Sri', label: 'Tan Sri' },
    { value: 'Toh Puan', label: 'Toh Puan' },
    { value: 'Tun', label: 'Tun' },
    { value: 'YB', label: 'YB' },
  ],
  genderList: [
  ...
  cities: [
    ...
    { label: 'Pasir Gudang', value: 'Pasir Gudang' },
    { label: 'Kuantan', value: 'Pasir Gudang' },
  ],
  states: [],
